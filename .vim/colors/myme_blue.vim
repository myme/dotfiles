...
hi Normal ctermfg=7 cterm=none guibg=#aabbff guifg=#220066 gui=none

hi Cursor guibg=#ccbbff guifg=fg gui=none
hi CursorColumn guibg=#30303a gui=none
hi CursorLine guifg=#110033 guibg=#ddddff gui=none
...
hi LineNr ctermfg=4 guibg=bg guifg=#222266 gui=none
...
hi StatusLine ctermbg=0 ctermfg=7 cterm=bold guibg=#000055 guifg=#aaaaff gui=bold
hi StatusLineNC ctermbg=0 ctermfg=4 cterm=bold guibg=#000055 guifg=#9999cc gui=none
...
hi VertSplit ctermbg=7 ctermfg=0 guibg=#440077 guifg=#aaaaff gui=none
if version >= 700
...
hi Comment ctermfg=5 guibg=bg guifg=#661199 gui=none
hi Constant ctermfg=1 cterm=bold guibg=bg guifg=#003300 gui=none
hi Error ctermfg=1 ctermbg=none cterm=bold guibg=bg guifg=#b03030 gui=none
hi Identifier ctermfg=4 guibg=bg guifg=#118822 gui=none
...
hi Statement ctermfg=2 cterm=bold guibg=bg guifg=#000077 gui=bold
